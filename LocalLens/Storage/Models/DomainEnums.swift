...
public enum ExtractionStage: String, Codable, CaseIterable, Sendable { case thumbnail, metadata, imageOCR, imageLabels, imageDescription, pdfText, pdfOCR, pdfSummary, audioTranscript, videoTranscript, videoKeyframe, sceneLabels, officeDocument, officeSummary, embeddings, audioVideoProviderSkipped }
public enum MatchReason: String, Codable, CaseIterable, Sendable, Hashable { case filename, visibleText, pdfText, transcript, visualLabel, imageDescription, pdfSummary, officeText, officeSummary, semantic }
...
public enum FailureCategory: String, Codable, CaseIterable, Sendable { case permissionDenied, staleBookmark, missingFolder, missingFile, unsupportedMedia, corruptedMedia, passwordProtectedPDF, modelUnavailable, providerTimeout, transportBlocked, unauthorized, invalidProviderOutput, providerSkipped, storageFull, databaseError, unknownRedacted, cancelled }
